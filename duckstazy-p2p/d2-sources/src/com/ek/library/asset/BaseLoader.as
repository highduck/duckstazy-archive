package com.ek.library.asset
{
	...
	internal class BaseLoader extends EventDispatcher
	{
		...
		// global app domain
		protected var _globalApplicationDomain:Boolean;
		...
		public function BaseLoader(url:String, type:String = LoaderType.UNKNOWN, antiCache:String = null, retryCount:int = 5, global:Boolean = false)
		{
			super();
			...
			_globalApplicationDomain = global;
		}
