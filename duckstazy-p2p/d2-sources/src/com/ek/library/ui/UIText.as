package com.ek.library.ui
{
	import com.ek.library.debug.Logger;
	import com.ek.library.gocs.IComponentContainer;
	import com.ek.library.text.StringManager;
	...
	public class UIText extends UIWrapper
	{
		...
		public static function scan(container:DisplayObjectContainer, localize:Boolean):void
		{
			var tf:TextField;
			var i:int;
			...
			if(container)
			{
				while(i < container.numChildren)
				{
					...
					{
						UIText.setup(tf);
						tf.text = StringManager.localize(tf.text);
					}
